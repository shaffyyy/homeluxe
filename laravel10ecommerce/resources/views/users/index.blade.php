                                ...
                                <table class="table cart-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="details.php">
                                                    <img src="" class="blur-up lazyload" alt="">
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @foreach ($order->orderItems as $item)
                                                    <p class="fs-6 m-0">{{ optional($item->product)->name }}</p>
                                                @endforeach
                                            </td>
                                            <td>
                                                <p class="success-button btn btn-sm">{{ optional($order->transaction)->status ?? 'No Transaction' }}</p>
                                            </td>
                                            <td>
                        ...
                        <div class="tab-pane fade table-dashboard dashboard wish-list-section" id="wishlist">
                            ...
                            @else
                                ...
                                <table class="table cart-table">
                                    ...
                                    <tbody>
                                        @foreach ($cartWishlist as $list)
                                        <tr>
                                            <td>
                                                <a href="details.php">
                                                    <img src="/products/{{$list->model->image}}" class="blur-up lazyload" alt="">
                                                </a>
                                            </td>
                                            <td>
                                                <p class="m-0">#{{$list->model->name}}</p>
                                            </td>
                                            
                                            <td>
                                                <p class="theme-color fs-6">${{$list->model->regular_price}}</p>
                                            </td>
                                            <td>
