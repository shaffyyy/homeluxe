                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                ...
                                <li>
                                    <span><b>Address:</b><span class="font-light">Poblacion Bani Pangasinan Philippines</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@homeluxe.in</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="shop.html" class="font-dark">Living Room</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Dining Room</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Bathroom</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Bedroom</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Kitchen</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Homeluxe.</p>
                    </div>
                </div>
            </div>
        </div>
