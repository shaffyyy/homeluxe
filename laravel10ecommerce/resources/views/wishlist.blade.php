    ...
    <div class="container">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('shop.product.details', ['slug' => $item->model->slug])}}" class="icon">
                                    <i class="fas fa-shopping-cart"></i>
                                </a>
                                <a href="javascript:void(0)" class="icon" onclick="removeFromWishlist('{{$item->model->rowId}}')">
                                    <i class="fas fa-times"></i>
                                </a>
                            </td>
                        </tr>    
        ...
        <div class="row">
            <div class="col-md-12 text-end">
                <a href="javascript:void(0)" onclick="clearWishlist()">Clear Items</a>
            </div>
        </div>
        @else 
            <div class="row">
...
<form id="deleteFromWishlist" action="{{route('wishlist.remove')}}" method="POST">
    @csrf
    @method('delete')
    <input type="hidden" type="rowId" name="rowId">
</form>
